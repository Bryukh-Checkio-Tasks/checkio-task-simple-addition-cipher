...
requirejs(['ext_editor_1', 'jquery_190', 'raphael_210', 'snap.svg_030'],
    function (ext, $, Raphael, Snap) {
        ...
        ext.set_animate_slide(function (this_e, data, options) {
            ...
            //YOUR FUNCTION NAME
            var fname = 'decode_vigenere';

            var checkioInput = data.in || ['DONTWORRYBEHAPPY', 'FVRVGWFTFFGRIDRF', 'DLLCZXMFVRVGWFTF'];
            var checkioInputStr = fname + '(' +
            "u" + JSON.stringify(checkioInput[0]) + ', ' +
            "u" + JSON.stringify(checkioInput[1]) + ', ' +
